...
import { InlayHintsProviderRegistry } from '../../common/modes';
import { flatten } from '../../../base/common/arrays';
import { editorInlayHintForeground, editorInlayHintBackground } from '../../../platform/theme/common/colorRegistry';
...
let InlayHintsController = class InlayHintsController {
    constructor(_editor, _codeEditorService, _themeService) {
        ...
        this._disposables.add(_editor.onDidChangeConfiguration(e => {
            if (e.hasChanged(123 /* inlayHints */)) {
                this._update();
            }
        }));
        this._update();
    ...
    _update() {
        ...
        if (!this._editor.getOption(123 /* inlayHints */).enabled) {
            this._removeAllDecorations();
            return;
        }
    ...
    _getLayoutInfo() {
        const options = this._editor.getOption(123 /* inlayHints */);
